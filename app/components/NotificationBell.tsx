      ...
      <AnimatePresence>
        {open && (
          <>
            ...
            >
              {/* Handle */}
              <div className="w-10 h-1 rounded-full bg-white/20 mx-auto mt-4 mb-5 flex-shrink-0" onPointerDown={e => dragControls.start(e)} style={{ touchAction: 'none', cursor: 'grab' }} />
