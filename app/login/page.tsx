    ...
    <main className="min-h-screen bg-black flex flex-col items-center justify-center px-8">
      <div className="flex flex-col items-center gap-10 w-full max-w-xs">
        ...
        <div className="text-center">
          ...
          <p className="text-white/35 text-sm mt-3 font-medium">
            Hold styr på hvad I ser – sammen
          </p>
        </div>
        ...
        <button
          ...
          className="flex items-center gap-3 bg-white/8 hover:bg-white/12 border border-white/10 text-white font-medium text-sm px-5 py-3 rounded-2xl transition-all active:scale-95"
        >
