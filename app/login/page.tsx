...
export default function LoginPage() {
  ...
  className="flex items-center gap-3 text-white font-medium text-sm px-5 py-3 rounded-2xl transition-all duration-200 active:scale-95 hover:brightness-125"
  style={{
